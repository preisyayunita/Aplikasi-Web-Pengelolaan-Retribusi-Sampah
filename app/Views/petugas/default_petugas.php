                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="<?= site_url('petugas/logout') ?>" class="dropdown-item has-icon text-danger">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= site_url('petugas/bukti_bayar') ?>">Retribusi Sampah</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= site_url('petugas/bukti_bayar') ?>">rS</a>
                    </div>
                    <ul class="sidebar-menu">
                        <?= $this->include('petugas/sidebar_petugas') ?>
                    </ul>
                </aside>
            </div>
